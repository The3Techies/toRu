...
export default function OurService() {
    ...
    const logo: Array<string> = [logoPath1, logoPath2, logoPath3,  logoPath4]
    const titles: Array<string> = ["مساعدة في اختيار الجامعات ", "ترجمة الوثائق", "إخراج قبولات وتأشيرات دراسية",  "استقبال من المطار وحتى الجامعة والسكن"]
    const pras: Array<string> = [
        "مساعدة في اختيار الجامعات والمدن المناسبة للطالب من حيث اسعار المعيشة والثقافات المناسبة والجامعات التي تتميز بالتخصصات المرغوبة.",
        "ترجمة الوثائق التي تطلبها الجامعات حين التسجيل الى اللغة الروسية او الإنجليزية.",
        "إخراج قبولات جامعية وتأشيرات دراسية للطلاب ومساعدتهم بالتواصل مع الجامعات.",
        "استقبال من المطار حتى الجامعة واكمال عملية التسجيل في الجامعة ثم التوصيل للسكن وانهاء الامور المتعلقة بالتسجيل في السكنات الطلابية.",
    ]
const arry= [
    {
        logo: logoPath1,
