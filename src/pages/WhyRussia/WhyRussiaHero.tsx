...
export default function WhyRussiaHero() {
    ...
    return (
        <div className="w-full mt-14 md:mt-10 flex justify-center  ">
            <div className="w-full max-w-6xl h-screen flex justify-start items-center bg-WhyRussia-hero-pattern bg-no-repeat bg-right-bottom bg-[length:cover] ">
