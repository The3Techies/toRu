...
const WhyRussiaHero = () => {
    ...
    return (
        <div className="w-full h-screen mt-[3.5rem] flex justify-center ">
            <div className=" max-w-6xl h-screen flex items-center bg-WhyRussia-heroSS md:bg-WhyRussia-hero bg-[length:250%_100%] md:bg-[length:100%_100%] bg-right bg-no-repeat justify-end">
                <div className="md:w-1/2 md:ml-10 mx-4 flex flex-col">
