...
export default function WhyRussiaHero() {
    ...
    return (
        <div className="w-screen h-screen mt-10 flex justify-center  ">
            <div className="w-screen max-w-6xl h-screen flex items-center bg-WhyRussia-heroSS md:bg-WhyRussia-hero bg-[length:250%_100%] md:bg-[length:100%_100%] bg-right bg-no-repeat ">
